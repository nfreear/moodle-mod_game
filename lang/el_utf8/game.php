...
$string[ 'cross_congratulations'] = 'Συγχαρητήρια';
...
$string[ 'cross_incomplete_words'] = ' μη συμπληρωμένες λέξεις';
$string[ 'cross_incomplete_word'] = ' μη συμπληρωμένη λέξη';
...
$string[ 'cross_noerrors_but1'] = 'Δεν βρέθηκαν λάθη αλλά ';
$string[ 'cross_noerrors_but2_many'] = ' λέξεις δεν συμπληρώθηκαν';
$string[ 'cross_noerrors_but2_one'] = '  λέξη δεν συμπληρώθηκε';
$string[ 'cross_nowords'] = 'Δεν βρέθηκε καμία λέξη';
$string[ 'cross_pleasewait'] = 'Παρακαλώ περιμένετε όση ώρα το σταυρόλεξο φορτώνει';
$string[ 'cross_spaces'] = 'κενά';
$string[ 'cross_space'] = 'κενό';
$string[ 'cross_welcome'] = '<h3>Καλωσήρθατε!</h3><p>Κάντε κλικ σε μία λέξη για να ξεκινήσετε.</p>';
$string[ 'cross_win'] = 'Συγχαρητήρια !!!';
$string[ 'cross_words'] = 'λέξεις';
$string[ 'cross_word'] = 'λέξη';
...
$string[ 'hangman_restletters'] = 'Έχετε ακόμη <b>$a</b> προσπάθειες';
...
$string[ 'sudoku_no_questions'] = 'Δεν βρέθηκαν ερωτήσεις';
...
$string[ 'sudoku_create'] = 'Δημιουργία νέων sudokus';
...
$string[ 'hideanswers'] = 'Απόκρυψη απαντήσεων';
...
$string['gametimelimit'] = 'Time limit: $a';
$string['gamenotavailable'] = 'Το παιχνίδι δε θα είναι διαθέσιμο μέχρι: $a';
$string['gameclosed'] = 'Αυτό το παιχνίδι έκλεισε $a';
...
$string['attemptshighest'] = 'Μεγαλύτερος βαθμός';
$string['attemptslast'] = 'Τελευταία προσπάθεια';
$string['pagesize'] = 'Ερωτήσεις ανά σελίδα:';
$string['qidtitle'] = 'Q#';
$string['qnametitle'] = 'Όνομα ερώτησης';
$string['qtexttitle'] = 'Κείμενο ερώτησης';
...
//English 
$string['attemptduration'] = 'Time taken'; $string['attemptduration'] = 'Διάρκεια παιχνιδιού';
$string['startedon'] = 'Started on'; $string['startedon'] = 'Ξεκίνησε στις';
$string['reportoverview'] = 'Overview'; $string['reportoverview'] = 'Σύνοψη';
$string['reportresponses'] = 'Detailed responses';
$string['unfinished'] = 'open';  $string['unfinished'] = 'Ατελείωτο';
$string['selectnone'] = 'Deselect all';
$string['deleteattemptcheck'] = 'Are you absolutely sure you want to completely delete these attempts?';
$string['selectnone'] = 'Deselect all';  $string['selectnone'] = 'Αποεπιλογή όλων';
$string['withselected'] = 'With selected';  $string['withselected'] = 'Με τα επιλεγμένα';
$string['displayoptions'] = 'Display options';  $string['displayoptions'] = 'Εμφάνιση παραμέτρων';
$string['showdetailedmarks'] = 'Show mark details';
$string['analysis'] = 'Show mark details';		$string['analysis'] = 'Ανάλυση';
$string['showdetailedmarks'] = 'Show mark details';  $string['showdetailedmarks'] = 'Λεπτομέρειες ερωτήσεων';
$string['noattemptsonly'] = 'Show $a with no attempts only';  $string['noattemptsonly'] = 'Εμφάνιση $a που δεν έχουν καθόλου προσπάθειες';
$string[ 'downloadods'] = 'Download in ODS format'; $string[ 'downloadods'] = 'Αποθήκευση σε μορφή ODS'; 
...
$string[ 'commentorgrade'] = 'Γράψτε ένα σχόλιο ή βαθμολογήστε την απάντηση';
...
$string[ 'hangman_allowsub'] =  'Τα επιτρέπεται το σύμβολο - στις λέξεις';
...
$string['hiddenpicture_finishattemptbutton'] = "Τέλος του παιχνιδιού η 'Η κρυμμένη εικόνα'";
$string['hiddenpicture_grade'] = "Βαθμολογία";
$string['hiddenpicture_mainsubmit'] = "Βαθμολόγησε την κυρίως ερώτησης";
$string['hiddenpicture_submit'] = "Βαθμολόγησε τις απαντήσεις";
