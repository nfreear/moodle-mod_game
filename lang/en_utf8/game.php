...
$string[ 'cross_congratulations'] = 'Congratulations';
...
$string[ 'cross_incomplete_words'] = ' not completed words';
$string[ 'cross_incomplete_word'] = ' no completed word';
...
$string[ 'cross_noerrors_but1'] = 'Not found errors but ';
$string[ 'cross_noerrors_but2_many'] = ' words not completed';
$string[ 'cross_noerrors_but2_one'] = '  word not completed';
$string[ 'cross_nowords'] = 'Not found any word';
$string[ 'cross_pleasewait'] = 'Please wait while cross is loading';
$string[ 'cross_spaces'] = 'spaces';
$string[ 'cross_space'] = 'space';
$string[ 'cross_welcome'] = '<h3>Welcome!</h3><p>Click on a word to begin.</p>';
$string[ 'cross_win'] = 'Congratulations !!!';
$string[ 'cross_words'] = 'words';
$string[ 'cross_word'] = 'word';
...
$string[ 'millionaire_no_questions'] = 'No questions found';
$string[ 'hangman_win'] = 'Congratulations';
$string[ 'millionaire_win'] = 'Congratulations !!!!';
...
$string['gameclosed'] = 'The game is closed $a';
$string['allattempts'] = 'All attempts';
...
$string[ 'sudoku_no_questions'] = 'No questions found';
...
$string[ 'bookquiz_subchapter'] = 'Subchapter';
...
$string['analysis'] = 'Show mark details';
$string['showdetailedmarks'] = 'Show mark details';
...
//1.6
$string['sudoku_submit'] = 'Grade answers';
$string['hiddenpicture_submit'] = 'Grade answers';
