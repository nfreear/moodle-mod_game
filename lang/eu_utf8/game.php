...
$string[ 'cross_congratulations'] = 'Zorionak';
...
$string[ 'cross_incomplete_words'] = ' betegabeko hitzak';
$string[ 'cross_incomplete_word'] = ' betegabeko hitza';
...
$string[ 'cross_noerrors_but1'] = 'Ez da errorerik aurkitu, baina ';
$string[ 'cross_noerrors_but2_many'] = ' betegabeko hitz';
$string[ 'cross_noerrors_but2_one'] = '  betegabeko hitza';
$string[ 'cross_nowords'] = 'Ez da hitzik aurkitu';
$string[ 'cross_pleasewait'] = 'Gurutzegrama kargatu bitartean itxaron, mesedez';
$string[ 'cross_spaces'] = 'espazioak';
$string[ 'cross_space'] = 'espazioa';
$string[ 'cross_welcome'] = '<h3>Ongi etorri!</h3><p>Hasteko hitz batean klik egin.</p>';
$string[ 'cross_win'] = 'Zorionak!!!';
$string[ 'cross_words'] = 'hitzak';
$string[ 'cross_word'] = 'hitza';
...
$string[ 'millionaire_no_questions'] = 'Ez da galderarik aurkitu';
...
$string[ 'sudoku_submit'] = 'Erantzunak ebaluatu';
...
$string[ 'useupdategame'] = ' \"Update this game\" botoia jolasaren zehaztapenak ikusteko erabili';
...
$string['numattempts'] = '$a->studentnum $a->studentstring saiakera hauen egilea izan da:  $a->attemptnum';
...
$string['temporaryblocked'] = 'Oraingoz ezin duzu jolasa berriz saiatu.<br /> Hurrengo saiakera noiz egingo duzun hemen ikusi:';
...
$string['noscript'] = 'Jarraitzeko JavaScript-a indarrean jarri behar da!';
$string['info'] = 'Info';
$string['results'] = 'Emaitza';
$string['preview'] = 'Aurreikusi';
$string['selectall'] = 'Denak aukeratu';
$string['regrade'] = 'Saiakera guztiak berriz kalifikatu';
...
$string['gametimelimit'] = 'Denbora muga: $a';
$string['gameclosed'] = 'Jolasa itxita dago $a';
$string['allattempts'] = 'Saiakera guztiak';
...
$string[ 'hangman_countwords'] = 'Zenbat hitz dauka jolas bakoitzak?';
...
$string[ 'sudoku_no_questions'] = 'Ez da galderarik aurkitu';
...
$string[ 'bookquiz_subchapter'] = 'Azpikapitulua';
...
$string[ 'sudoku_create'] = 'Sudoku berrien datubasea sortu';
...
$string[ 'hideanswers'] = 'Erantzunak izkutatu';
$string[ 'must_select_glossary'] = 'Glosategia aukeratu behar duzu';
$string[ 'bottomtext'] = 'Bukaerako testua';
$string[ 'messagewin'] = 'Ikasleak irabazten duenean erakutsi beharreko mezua';
$string[ 'messageloose'] = 'Ikasleak galtzen duenean erakutsi beharreko mezua';
...
//1.4
$string['popupblockerwarning'] = 'Pop-up leihoa blokeatu delako abisua';
$string['attemptsallowed'] = 'Baimendutako saiakerak';
$string['gamenotavailable'] = 'Galdetegi hau ez da eskuragarri izango data honetaraino: $a';
...
$string['attemptshighest'] = 'emaitza hoberena';
...
$string['reportresponses'] = 'Erantzunen zehaztapenak';
...
$string['analysis'] = 'Marka-zehaztapenak erakutsi';
$string['showdetailedmarks'] = 'Marka-zehaztapenak erakutsi';
...
$string['hiddenpicture_submit'] = 'Erantzunak aztertu';
$string['hiddenpicture_finishattemptbutton'] = 'Irudi izkutuaren jolasa bukatu da';
$string[ 'hiddenpicture_mainsubmit'] = 'Erantzuna aztertu';
