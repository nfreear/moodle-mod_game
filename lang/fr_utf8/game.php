...
$string[ 'cross_congratulations'] = 'Bravo';
...
$string[ 'cross_incomplete_words'] = ' mots incomplets';
$string[ 'cross_incomplete_word'] = ' mot incomplet';
...
$string[ 'cross_noerrors_but1'] = 'Pas d\'erreurs, mais il reste ';
$string[ 'cross_noerrors_but2_many'] = ' mots non terminés';
$string[ 'cross_noerrors_but2_one'] = '  mot non terminé';
$string[ 'cross_nowords'] = 'Aucun mot trouvé';
$string[ 'cross_pleasewait'] = 'Attendez le chargement du mot-croisé';
$string[ 'cross_spaces'] = 'espaces';
$string[ 'cross_space'] = 'espace';
$string[ 'cross_welcome'] = '<h3>Bienvenue !</h3><p>Cliquez sur un mot pour commencer.</p>';
$string[ 'cross_win'] = 'Bravo !!!';
$string[ 'cross_words'] = 'mots';
$string[ 'cross_word'] = 'mot';
...
$string[ 'millionaire_no_questions'] = 'Aucune question';
...
$string['temporaryblocked'] = 'Vous ne pouvez pas effectuer de nouvelles tentatives pour l\'instant.<br /> Vous pourrez recommencer à partir de :';
$string['confirmstartattempttimelimit'] = 'Ce jeu est limité dans le temps et au nombre de $a tentative(s). Vous commencez une nouvelle tentative. Voulez-vous continuer ?';
$string['confirmstarttimelimit'] = 'Ce jeu est limité dans le temps. Etes-vous sûr(e) de vouloir commencer ?';
$string['confirmstartattemptlimit'] = 'Ce jeu est limité à $a tentative(s). Vous allez commencer une tentative. Voulez-vous continuer ?';
$string['noscript'] = 'JavaScript doit être activé !';
$string['info'] = 'Info';
...
$string['gametimelimit'] = 'Limite de temps : $a';
$string['gameclosed'] = 'Le jeu est fermé $a';
$string['allattempts'] = 'Toutes les tentatives';
...
$string[ 'hangman_countwords'] = 'Combien de mots pour chaque jeu ?';
...
$string[ 'sudoku_no_questions'] = 'Aucune question trouvée';
...
$string[ 'bookquiz_subchapter'] = 'Sous-chapitre';
...
$string[ 'sudoku_create'] = 'Créer la base de données de sudokus';
...
$string[ 'hideanswers'] = 'Cacher les réponses';
$string[ 'must_select_glossary'] = 'Vous devez choisir un glossaire';
$string[ 'bottomtext'] = 'Texte au bas';
$string[ 'messagewin'] = 'Mesage quand l\'étudiant gagne le jeu';
$string[ 'messageloose'] = 'Message quand l\'étudiant échoue';
...
$string['gamenotavailable'] = 'Le test ne sera pas disponible jusqu\'au : $a';
...
$string['attemptshighest'] = 'note maximale';
$string['attemptslast'] = 'dernière tentative';
$string['pagesize'] = 'Questions par page :';
$string['qidtitle'] = 'Q#';
$string['qnametitle'] = 'Nom dela question';
$string['qtexttitle'] = 'Texte de la question';
...
$string['allstudents'] = 'Montrer tout $a';
...
$string['analysis'] = 'Montrer les marques de détail';
$string['showdetailedmarks'] = 'Montrer les marques de détail';
