...
$string[ 'cross_congratulations'] = 'Čestitamo';
...
$string[ 'cross_incomplete_words'] = ' nezavršenih riječi';
$string[ 'cross_incomplete_word'] = ' nezavršena riječ';
...
$string[ 'cross_noerrors_but1'] = 'Nisu pronađene greške ali ';
$string[ 'cross_noerrors_but2_many'] = ' riječi nije završeno';
$string[ 'cross_noerrors_but2_one'] = '  riječ nije završena';
$string[ 'cross_nowords'] = 'Nije pronađena ni jedna riječ';
$string[ 'cross_pleasewait'] = 'Molimo pričekajte dok se križaljka učita';
$string[ 'cross_spaces'] = 'razmaka';
$string[ 'cross_space'] = 'razmak';
$string[ 'cross_welcome'] = '<h3>Dobrodošli!</h3><p>Za početak igre odaberite riječ.</p>';
$string[ 'cross_win'] = 'Čestitamo !!!';
$string[ 'cross_words'] = 'riječi';
$string[ 'cross_word'] = 'riječ';
...
$string[ 'millionaire_no_questions'] = 'Pitanja nisu pronađena';
...
$string['temporaryblocked'] = 'Privremeno vam nije dozvoljeno ponovno igranje ove igre.<br /> Možete ponovo pokušatu u ovo vrijeme:';
...
$string['noscript'] = 'JavaScript mora biti omogućen za nastavak!';
...
$string['gametimelimit'] = 'Vremensko ograničenje: $a';
$string['gameclosed'] = 'Igra je zatvorena $a';
$string['allattempts'] = 'Svi pokušaji';
...
$string[ 'hangman_countwords'] = 'Broj riječi u svakoj igri?';
...
$string[ 'preview'] = 'Pregled';
$string[ 'selectgame'] = 'Odaberi igru';
...
$string[ 'sudoku_no_questions'] = 'Pitanja nisu pronađena';
...
$string[ 'bookquiz_subchapter'] = 'Podpoglavlje';
...
$string[ 'sudoku_create'] = 'Napravi novu sudoku bazu';
...
$string[ 'hideanswers'] = 'Sakrij odgovore';
$string[ 'must_select_glossary'] = 'Morate odabrati rječnik';
$string[ 'createtoptext'] = 'Tekst na vrhu';
$string[ 'bottomtext'] = 'Tekst na dnu';
$string[ 'messagewin'] = 'Poruka kad student pobjedi';
$string[ 'messageloose'] = 'Poruka kad student izgubi';
...
$string['gamenotavailable'] = 'Ova igra nije dostupna do: $a';
...
$string['attemptshighest'] = 'najveća ocjena';
$string['attemptslast'] = 'posljednji pokušaj';
...
$string['analysis'] = 'Prikaži detalje ocjena';
$string['showdetailedmarks'] = 'Prikaži detalje ocjena';
...
//1.6
$string['sudoku_submit'] = 'Ocjeni odgovore';
$string['hiddenpicture_submit'] = 'Ocjeni odgovore';
$string['hiddenpicture_finishattemptbutton'] = 'Kraj igre skrivena slika';
...
$string[ 'hangman_html_new'] = 'Novo';
$string[ 'html_hangman_inputsize'] = 'Veličina polja za unos:';
