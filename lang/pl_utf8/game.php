...
$string[ 'cross_congratulations'] = 'Gratulacje';
...
$string[ 'cross_incomplete_words'] = ' nie ukończonych słów';
$string[ 'cross_incomplete_word'] = ' nie ukończone słowo';
...
$string[ 'cross_noerrors_but1'] = 'nie znaleziono błędów ale ';
$string[ 'cross_noerrors_but2_many'] = ' słów nie zostało dokończonych';
$string[ 'cross_noerrors_but2_one'] = '  słowo nie zostało dokończone';
$string[ 'cross_nowords'] = 'Nie znaleziono żadnych słów';
$string[ 'cross_pleasewait'] = 'Prosze czekać na załadowanie krzyżówki';
$string[ 'cross_spaces'] = 'spacje';
$string[ 'cross_space'] = 'spacja';
$string[ 'cross_welcome'] = '<h3>Witaj!</h3><p>Kliknij na słowo aby rozpocząć.</p>';
$string[ 'cross_win'] = 'Gratulacje !!!';
$string[ 'cross_words'] = 'słowa';
$string[ 'cross_word'] = 'słowo';
...
$string[ 'millionaire_no_questions'] = 'Nie znaleziono pytań';
...
$string['numattempts'] = '$a->studentnum studentów dokonało $a->attemptnum prób';
...
$string['temporaryblocked'] = 'Tymczasowo nie masz prawa ponownego podjęcia gry.<br />Będziesz mógł podjąć kolejną próbę: ';
$string['confirmstartattempttimelimit'] = 'Ta gra ma ograniczenie czasowe i limit $a prób. Za chwilę rozpoczniesz nową próbę. Czy chcesz kontynuować?';
$string['confirmstarttimelimit'] = 'Ta gra ma ograniczenie czasowe. Czy na pewno chcesz rozpocząć?';
$string['confirmstartattemptlimit'] = 'Ta gra ma limit $a prób. Za chwilę rozpoczniesz nową próbę. Czy chcesz kontynuować?';
$string['noscript'] = 'JavaScript musi być włączony by kontynuować!';
$string['info'] = 'Informacje';
$string['results'] = 'Wyniki';
$string['preview'] = 'Podgląd';
$string['selectall'] = 'Wybierz wszystkie';
$string['regrade'] = 'Oceń ponownie wszystkie próby';
...
$string['gametimelimit'] = 'Limit czasu: $a';
$string['gameclosed'] = 'Gra jest zablokowana $a';
$string['allattempts'] = 'Wszystkie próby';
...
$string[ 'hangman_countwords'] = 'Ile słów przypada na jedną grę ?';
...
$string[ 'sudoku_no_questions'] = 'Nie znaleziono pytań';
...
$string[ 'bookquiz_subchapter'] = 'Podrozdział';
...
$string[ 'sudoku_create'] = 'Stwórz bazę danych nowych sudoku';
...
$string[ 'hideanswers'] = 'Ukryj odowiedzi';
$string[ 'must_select_glossary'] = 'Musisz wybrać słownik';
$string[ 'bottomtext'] = 'Tekst na dole';
$string[ 'messagewin'] = 'Komunikat po wygranej';
$string[ 'messageloose'] = 'Komunikat po przegranej';
...
$string['gamenotavailable'] = 'Quiz nie będzie dostępny aż do: $a';
...
$string['analysis'] = 'Pokaż szczegóły oceny';
$string['showdetailedmarks'] = 'Pokaż szczegóły oceny';
...
//1.6
$string['sudoku_submit'] = 'Oceń odpowiedzi';
$string['hiddenpicture_submit'] = 'Oceń odpowiedzi';
$string['hiddenpicture_finishattemptbutton'] = 'Koniec gry ukryty obraz';
