...
$string[ 'cross_congratulations'] = 'Поздравляем!';
...
$string[ 'cross_incomplete_words'] = ' не оконченные слова';
$string[ 'cross_incomplete_word'] = ' не оконченное слово';
...
$string[ 'cross_noerrors_but1'] = 'Ошибок не найдено, но ';
$string[ 'cross_noerrors_but2_many'] = ' неполные слова';
$string[ 'cross_noerrors_but2_one'] = '  слово не полное';
$string[ 'cross_nowords'] = 'Не найдено ни одного слова';
$string[ 'cross_pleasewait'] = 'Пожалуйста, обождите, кроссворд загружается';
$string[ 'cross_spaces'] = 'пробелы';
$string[ 'cross_space'] = 'пробел';
...
$string[ 'millionaire_no_questions'] = 'Не найдено вопросов';
...
$string['numattempts'] = '$a->studentnum $a->studentstring должны слелать $a->attemptnum попыток';
...
$string['temporaryblocked'] = 'Вам временно запрещено возобновлять попытки для этой игры.<br /> Вам можно начинать играть в:';
$string['confirmstartattempttimelimit'] = 'Эта игра ограниченна по времени и по количеству попыток ($a). Вы действительно желаете сделать еще одну попытку?';
$string['confirmstarttimelimit'] = 'Время игры ограничено. Вы уверены в том, что хотите начать игру?';
$string['confirmstartattemptlimit'] = 'Кличество попыток в этой игре ограниченно $a попытками. Вы собираетесь начать новую попытку. Продолжить?';
$string['noscript'] = 'Для загрузки игры необходимо включить в вашем броузере JavaScript';
$string['info'] = 'Информация';
$string['results'] = 'Результаты';
$string['preview'] = 'Предварительный просмотр';
$string['selectall'] = 'Выбрать все';
$string['regrade'] = 'Удалить отметки со всех попыток';
...
$string['gametimelimit'] = 'Ограничение времени limit: $a';
$string['gameclosed'] = 'Игра закрыта $a';
$string['allattempts'] = 'Все попытки';
...
$string[ 'hangman_countwords'] = 'Сколько слов в одной игре ?';
...
$string[ 'sudoku_no_questions'] = 'Вопросы не найдены';
...
$string[ 'bookquiz_subchapter'] = 'Подглава';
...
$string[ 'sudoku_create'] = 'Создать базу данных для нового \"Судоку\"';
...
$string[ 'hideanswers'] = 'Спрятать ответы';
$string[ 'must_select_glossary'] = 'Вы должны выбрать глоссарий';
$string[ 'bottomtext'] = 'Текст внизу экрана игры';
$string[ 'messagewin'] = 'Текст сообщения о выиграше';
$string[ 'messageloose'] = 'Текст сообщения о проиграше';
...
$string['gamenotavailable'] = 'Этот тест не доступен до: $a';
...
$string['allstudents'] = 'Показать все $a';
...
$string['reportresponses'] = 'Детали ответов';
...
//1.6
$string['sudoku_submit'] = 'Оценить ответы';
$string['hiddenpicture_submit'] = 'Оценить ответы';
$string['hiddenpicture_finishattemptbutton'] = 'Конец игры \"Спрятанная картинка\"';
