...
$string[ 'cross_congratulations'] = 'Вітання';
...
$string[ 'cross_incomplete_words'] = ' порожніх слів';
$string[ 'cross_incomplete_word'] = ' порожне слово';
...
$string[ 'cross_noerrors_but1'] = 'Не знайшлись помилки, але ';
$string[ 'cross_noerrors_but2_many'] = ' слів  ще не завершено';
$string[ 'cross_noerrors_but2_one'] = '  слово ще не завершено';
$string[ 'cross_nowords'] = 'Не знайшлось жодного слова';
$string[ 'cross_pleasewait'] = 'Будь ласка, зачекайте завантаження кросворду';
$string[ 'cross_spaces'] = 'прожних';
$string[ 'cross_space'] = 'порожне';
$string[ 'cross_welcome'] = '<h3>Ласкаво просимо!</h3><p>Щоб почати, натисніть на слово.</p>';
$string[ 'cross_win'] = 'Вітання!!!';
$string[ 'cross_words'] = 'слів';
$string[ 'cross_word'] = 'слово';
...
$string[ 'cryptex_giveanswer'] = 'Дайте відповідь';
...
$string[ 'millionaire_no_questions'] = 'Не знайшлось жодного питання';
...
$string[ 'sudoku_no_questions'] = 'Запитання не знайдено';
...
$string[ 'sudoku_create'] = 'Створити нове судоку';
...
$string[ 'hideanswers'] = 'Приховати відповіді';
$string[ 'must_select_glossary'] = 'Ви повинні вибрати οπωσδήποτε один словник';
$string[ 'tries'] = 'Спроб';
$string[ 'bottomtext'] = 'Текст в нижній частині сторінки';

$string[ 'messagewin'] = 'Повідомлення відображаеться коли учень перемогає';
$string[ 'messageloose'] = 'Повідомлення відображаеться коли учень втрачає';
...
$string[ 'gametimelimit'] = 'Обмежений час: $a';
$string[ 'gamenotavailable'] = 'Гра не буде доступна до тих пір,поки: $a';
$string[ 'gameclosed'] = 'Ця гра закінчилася $a';
$string[ 'allattempts'] = 'Всі зусилля';
...
$string[ 'temporaryblocked'] = 'Тимчасово не дозволяється повторна спроба ігри.<br /> Ви зможете зробити ще одну спробу через:';
$string[ 'confirmstartattempttimelimit'] = 'Ця гра має обмеженний час також вона обмежена до $a спроби(спроб). Ви збираєтесь почати нову спробу.Хочете продовжити?';
$string[ 'confirmstarttimelimit'] = 'Гра має обмеженний час. Ви впевнені, що ви хочете почати цю гру?';
$string[ 'confirmstartattemptlimit'] = 'Ця гра обмежена до $a спробу(спроб). Ви збираєтся почати нову спробу. Ви хочете продовжити?';
$string[ 'noscript'] = 'Будь-ласка, увімкніть JavaScript перед тим, як продовжити!';
$string[ 'info'] = 'Інформація';
$string[ 'results'] = 'Результати';
$string[ 'preview'] = 'Πерегляд';
$string[ 'selectall'] = 'Виділити все';
$string[ 'regrade'] = 'Переоцінування усіх спроб';

$string[ 'attemptsall'] = 'Всі спроби';
$string[ 'attemptsfirst'] = 'Перша спроба';
$string[ 'attemptshighest'] = 'найбільша оцінка';
$string[ 'attemptslast'] = 'Остання спроба';
$string[ 'pagesize'] = 'Питання на сторінці:';
$string[ 'qidtitle'] = 'Q#';
$string[ 'qnametitle'] = "Ім'я питання";
$string[ 'qtexttitle'] = 'Текст питання';
...
$string[ 'commentorgrade'] = 'Напишіть коментарый або дайте оцінку  цього питання';
...
$string[ 'hiddenpicture_finishattemptbutton'] = "Гра закінчена 'Приховане зображення'";
$string[ 'hiddenpicture_grade'] = "Оцінка";
$string[ 'hiddenpicture_mainsubmit'] = "Оцініть питання";
$string[ 'hiddenpicture_submit'] = "Оцінити відповіді";
